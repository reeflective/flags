...
func convertInt(val string, valType reflect.Type, retval reflect.Value, options multiTag) error {
...
func convertIntStr(val reflect.Value, options multiTag) (string, error) {
	base, err := getBase(options, baseParseInt)
	if err != nil {
		return "", err
	}
...
func convertUint(val string, valType reflect.Type, retval reflect.Value, options multiTag) error {
	base, err := getBase(options, baseParseInt)
	if err != nil {
		return err
	}
...
func convertUintStr(val reflect.Value, options multiTag) (string, error) {
	base, err := getBase(options, baseParseInt)
	if err != nil {
		return "", err
	}
...
func convertSlice(val string, valType reflect.Type, retval reflect.Value, options multiTag) error {
	elemtp := valType.Elem()
...
func convertSliceStr(val reflect.Value, options multiTag) (string, error) {
	if val.Len() == 0 {
		return "", nil
	}
...
func convertMap(val string, valType reflect.Type, retval reflect.Value, options multiTag) error {
...
func convertMapStr(val reflect.Value, options multiTag) (string, error) {
	ret := "{"
