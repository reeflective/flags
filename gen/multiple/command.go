...
type cliOpts struct {
	// The command created to manage multiple runs of any other command(set).
...
func WithMultipleAlt(command string) OptFunc {
...
func WithMultiple(command string) flags.OptFunc {
	// return func(opt *cliOpts) {
	// 	opt.multipleManager = true
	// 	opt.multipleCommandName = command
	// }
