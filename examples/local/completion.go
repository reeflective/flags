...
type CompletedOptions struct {
	...
	Files []string `short:"f" long:"files" complete:"Files"`
	...
	SpecialFile string `short:"s" long:"spe" complete:"FilterDirs,~/.app/logs,~/.app/data"`
	...
	Endpoints []IP `short:"a" long:"addr" complete:"MyIPCompleter"`
}
